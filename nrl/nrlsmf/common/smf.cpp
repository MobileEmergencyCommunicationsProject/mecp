...
Smf::Interface::Interface(unsigned int ifIndex)
 : if_index(ifIndex), resequence(false), dup_detector(NULL), assoc_top(NULL), 
   user_data(NULL)
{
}
...
Smf::Interface::Associate* Smf::Interface::FindAssociate(unsigned int ifIndex) const
{
...
Smf::Interface::AssociateIterator::AssociateIterator(const Interface& iface)
 : iface(iface), assoc_next(iface.assoc_top)
{
}
...
Smf::Interface::Associate::Associate(Smf::Interface& iface)
  : iface(iface), relay_type(CF), next(NULL)
{
}
