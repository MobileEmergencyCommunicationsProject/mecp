...
class NormSession
{
    ...
    public:
        ...
        // This can only be called for unstarted or "tx-only" sessions (i.e. rx_socket closed)
        bool ChangeSessionAddress(const char* sessionAddr, UINT16 sessionPort);
    ...
    private:
        ...
        bool                            acking_auto_populate;  // if true, "auto populate" acking node list
