...
public class NormSession {
  ...
  public native void setTxPort(int port);

  public native void setRxPortReuse(boolean enable, boolean bindToSessionAddr);
  ...
  public native void startSender(int sessionId, long bufferSpace,
      int segmentSize, int blockSize, int numParity) throws IOException;
  ...
  public native void setAutoParity(byte autoParity);
