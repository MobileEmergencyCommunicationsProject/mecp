...
//                    {return reinterpret_cast<Interface*>((void*)addr_list.GetUserData(addr));}              
                ...
                class SimpleList : public NetGraph::Interface::SimpleList
                {
                    public:
                        ...
                        MY_TYPE* GetHead() const
                            {return static_cast<InterfaceTemplate*>(NetGraph::Interface::SimpleList::GetHead());}
                        
                        MY_TYPE* RemoveHead()
                            {return static_cast<InterfaceTemplate*>(NetGraph::Interface::SimpleList::RemoveHead());}
        ...
        template <class IFACE_TYPE = Interface>
