...
* provided here that use the more basis Protolib data structure
* class like "ProtoList", "ProtoTree",and "ProtoSortedTree"
*
...
* may be included in a given list.
*
*/
...
class ProtoSimpleQueue : public ProtoQueue
{
    public:
        ...
        void Empty();  // does not delete enqueued items, just empties list
        
        // TBD - add a Destroy() method
...
class ProtoSortedQueueTemplate : public ProtoSortedQueue
{
    public:
        ...
        // Remove the "item" from the tree
        void Remove(ITEM_TYPE& item)
            {return ProtoSortedQueue::Remove(item);}
