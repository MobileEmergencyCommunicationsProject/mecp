...
#    SYSTEM_CFLAGS = -Wall -Wcast-align -pedantic
#    SYSTEM_HAVES =

# Executables must link with $SYSTEM_LIB_EX
#
#    SYSTEM_LIB_EX = -lnetfilter_queue
#    SYSTEM = linux

#    QMAKE_CFLAGS_DEBUG +=  -O $(SYSTEM_CFLAGS) -fPIC  $(INCLUDES)
#    QMAKE_CFLAGS_RELEASE += -O $(SYSTEM_CFLAGS) -fPIC $(INCLUDES)
